  ...
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/hardrock/07.jpg" class="img-responsive" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <a href="http://sitios.globalpark.com.mx/HardRock/" target="_blank"><h3 class="centered Roboto">Entrar al sitio</h3></a> -->
            <h3 class="centered Roboto">La Batalla Mundial de Bandas es un concurso organizado por Hard Rock Cafe alrededor del mundo. Participan bandas por regiones y el ganador toca en Hyde Park en Londres.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
             <a href="http://sitios.globalpark.com.mx/HardRock/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/hardrock/web.png" class="img-responsive"></a>
          </div>
        </div>
      </div>
    </section>

    <section class="proyecto Roboto" style="background-color:#d47f2f;">
      <div class="container">
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-sm hidden-xs" style="height:130px"></div>
            <h1 class=" centered">Boletos</h1>
            <h3 class="centered Roboto">Usando los lineamientos mundiales, se creó toda la imagen de Hard Rock para la Batalla de Bandas. Flyers, boletos, pósters, banners y página Web son algunas de las aplicaciones que se hicieron para la promoción del concurso.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/hardrock/folletos.png" class="img-responsive">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="proyecto Roboto">
      <div class="container">
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-xs-12">
            <h1 class=" centered">Banners/Flyers/Anuncios</h1>
          </div>
          <div class="col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/hardrock/banner.jpg" class="img-responsive">
          </div>
          <div class="col-xs-12" style="margin-top: 20px;">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/hardrock/anuncio.png" class="img-responsive">
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameHardRock" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
