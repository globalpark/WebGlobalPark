  ...
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/14h.jpg" class="img-responsvie" style="width:100%">
    ...
    <section id="start" class="proyecto Roboto" style="margin-top:-20px;">
      <div class="container-fluid" style="margin-top:20px; padding: 0 0 0 0;">
        <div class="row-fluid">
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://sitios.globalpark.com.mx/AbiertoPolo/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/01.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://adam-milo.com.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/02.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://animartudia.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/03.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://sitios.globalpark.com.mx/Attico/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/04.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://www.grupoayusa.net" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/05.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://www.conseti.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/06.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://sitios.globalpark.com.mx/Contenido/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/07.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://dharma.la" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/08.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://foro-o.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/09.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://www.excelenciamedica.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/10.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://lacastana.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/11.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://lapergolacafe.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/12.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://sitios.globalpark.com.mx/LadyJosefina/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/13.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://www.mexicovselhambre.org" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/14.jpg" class="img-responsive"></a>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-6 fotoSmall">
            <a href="http://globalpark.com.mx/diseno-web/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/diseno/15.jpg" class="img-responsive"></a>
          </div>
        </div>
