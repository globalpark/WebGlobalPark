...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/alegria/10.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:60px; margin-bottom:60px;">
          <div class="col-sm-6 col-xs-12">
            <a href="http://ninosenalegria.org.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/alegria/web.png" class="img-responsive"></a>
          </div>
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Web</h1>
            <h3 class="centered"><a href="http://ninosenalegria.org.mx" class="Roboto" target="_blank">Entrar al sitio</a></h3>
            </br>
            <h3 class="centered Roboto">Esta fundación basada en Acapulco, Guerrero, se encarga de apoyar a la educación en México, aunque fundamentalmente en ese estado.</h3>
            <h3 class="centered Roboto">Principalmente construyen y remodelan escuelas de bajos recursos, pero también se encargan de capacitar maestros, colecta de útiles y becas.</h3>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameAlegria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://ninosenalegria.org.mx/" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
