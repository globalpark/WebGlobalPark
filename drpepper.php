...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/drpepper/06.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:60px; margin-bottom:40px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <!-- <h3 class="centered Roboto"><a href="#" data-toggle="modal" data-target="#" class="Roboto">Entrar al sitio</a></h3> -->
            </br>
            <h3 class="centered Roboto">El concurso El Auténtico Americano, fue un concurso de lealtad a la marca, que consistió en llevar al ganador a Pasadena, Estados Unidos a la final del Futbol Americano colegial. Proyecto en conjunto con Mapa Producciones.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/drpepper/web.png" class="img-responsive">
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameDrPepper" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
