<?php
//Template Name: Contenido Alternativo 
?>
<?php get_header(); ?>
...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/03.jpg" class="img-responsvie" style="width:100%">
    ...
    <section id="start" class="proyecto Roboto">
      <div class="container">
        <div class="row" style="margin-top:60px; margin-bottom:40px;">
          <div class="col-sm-6 col-xs-12">
            <a href="http://sitios.globalpark.com.mx/Contenido/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/web01.png" class="img-responsive centered"></a>
          </div>
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered" style="vertical-align:middle;">Web</h1>
            <h3 class="centered"><a href="http://sitios.globalpark.com.mx/Contenido/" target="_blank" class="Roboto">Entrar al sitio</a></h3>
            <h3 class="centered Roboto">Contenido Alternativo es la primera distribuidora de contenidos digitales, especializada en contenido alternativo para cines en México y Centroamérica. Cuenta con tres empresas que se especializan en distribuir y proyectar contenidos alternativos.</h3> 
            <h3 class="centered Roboto">A través de TPL se encarga de distribuir películas y otros contenidos a clientes como Universal Pictures y Warner Brothers. Mientras que Sharing es un medio por el cual se dan cursos y capacitaciones a distancia en las salas de cine.</h3>
          </div>
        </div>
    </section>

    <section class="proyecto Roboto" style="background-color:#fff;">
      <div class="container">
        <div class="row" style="margin-top:40px; margin-bottom: 60px; background-color:#fff;">
          <div class="col-sm-6 col-xs-12">
            <a href="http://www.sharing.mx/" target="_blank" data-toggle="modal"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/web02.png" class="img-responsive"></a>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="http://www.tpl.mx/" target="_blank" data-toggle="modal"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/web03.png" class="img-responsive"></a>
          </div>
        </div>
      </div>
    </section>

    <section class="proyecto Roboto">
      <div class="container">
        <div class="row" style="margin-top:60px;">
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/newborn.png" class="img-responsive centered" width="220px">
            <a href="http://newborn.mx/" target="_blank"><h3 class="centered Roboto" style="vertical-align:middle;">Entrar al sitio</h3></a>
            <h3 class="centered Roboto">En la página de Newborn Entertainment se muestra la cartelera de los contenidos y dónde de proyectarán. En la sección de Cartelera, un banner lateral muestra todas las opciones disponibles y anteriores, cada una con su propia sección con sinopsis y trailer.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="http://newborn.mx/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/web04.png" class="img-responsive centered"></a>
          </div>
        </div>
        <div class="row" style="margin-top:60px; margin-bottom:40px;">
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/senna.png" class="img-responsive centered" width="220px">
            <a href="#" target="_blank"><h3 class="centered Roboto" style="vertical-align:middle;">Entrar al sitio</h3></a>
            <h3 class="centered Roboto">A través de Newborn Entertainment, Contenido Alternativo tuvo la tarea de proyectar y distribuir el documental Senna en 2011. Se creó un micrositio de la película con el fin de mostrar su sinopsis y trailer, así como información de la película.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="#" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/contenido/web05.png" class="img-responsive centered"></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameContenido1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://www.contenidoalternativo.mx/" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
    ...
    <div class="modal fade" id="iFrameContenido2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://www.sharing.mx/" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
              <button href="#" type="button" data-dismiss="modal" style="background: none; border: none; margin: 0 0 0 0; float: right;"><i class="fa fa-times fa-5x" style="color:#fff;"></i></button>
            </div>
    ...
    <div class="modal fade" id="iFrameContenido3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://www.tpl.mx/" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
              <button href="#" type="button" data-dismiss="modal" style="background: none; border: none; margin: 0 0 0 0; float: right;"><i class="fa fa-times fa-5x" style="color:#fff;"></i></button>
            </div>
    ...
    <div class="modal fade" id="iFrameContenido4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://newborn.mx/" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
              <button href="#" type="button" data-dismiss="modal" style="background: none; border: none; margin: 0 0 0 0; float: right;"><i class="fa fa-times fa-5x" style="color:#fff;"></i></button>
            </div>
    ...
    <div class="modal fade" id="iFrameContenido5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
              <button href="#" type="button" data-dismiss="modal" style="background: none; border: none; margin: 0 0 0 0; float: right;"><i class="fa fa-times fa-5x" style="color:#fff;"></i></button>
            </div>
