...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/mint/11.jpg" class="img-responsvie" style="width:100%">
    ...
    <section id="start" class="proyecto Roboto">
      <div class="container">
        <div class="row" style="margin-top:40px;">
          <h3 class="Roboto centered">Mint Creative Lab es una empresa de diseño y desarrollo de eventos. Con una amplia cartera de clientes de talla internacional, se encargan de hacer de cualquier evento una experiencia inolvidable.</h3>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom:40px;">
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Web App</h1>
            </br>
            <h3 class="centered Roboto">Como parte de la presencia de Pepsi dentro del Festival Marvin, crearon el Pepsi Fútbol Mix, con diferentes actividades y activaciones en el Festival. Una de ellas fue la creación de códigos QR personalizados para los invitados. </h3> 
            <h3 class="centered Roboto">Estos códigos se imprimían en etiquetas tamaño media carta para que los invitados los pegaran sobre ellos mismos u otros invitados y así leer los diferentes mensajes con sus teléfonos.</h3>
            <h3 class="centered Roboto">Se desarrolló la aplicación Web para pasar los códigos a una base de datos e imprimirlos, así como el manejo de la base de datos e impresión dentro del evento.</h3>
            <h3 class="centered Roboto">Puedes encontrar a Mint Creative Lab en <a href="http://mint.com.mx" target="_blank">mint.com.mx</a></h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/mint/web_app.png" class="img-responsive centered" style="width:750px;">
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameAbax" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
