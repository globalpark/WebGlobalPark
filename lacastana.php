  ...
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/08.jpg" class="img-responsvie" style="width:100%">
    ...
    <section id="start" class="proyecto Roboto">
      <div class="container">
        <div class="row" style="margin-top:40px; margin-bottom: 20px;">
          <h3 class="Roboto centered">La Castaña es una empresa familiar dedicada a productos de repostería, bocadillos y canapés de alta calidad. Con más de 30 años en el mercado, es una de las pastelerías más conocidas del área Poniente y Sur de la ciudad.</h3>
        </div>
        <div class="row" style="margin-top:20px; margin-bottom:80px;">
          <div class="col-sm-6 col-xs-12">
            <div class="col-sm-12 col-xs-6">
              <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/logo01.png" class="img-responsive centered" style="width:280px; margin-top:20px;">
            </div>
            <div class="col-sm-12 col-xs-6">
              <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/logo02.png" class="img-responsive centered" style="width:280px; margin-top:20px;">
            </div>
          </div>
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Logotipo</h1>
            </br>
            <h3 class="centered Roboto">Los clientes de La Castaña la conocen por su experiencia y tradición, por lo que no funcionaría hacer un diseño nuevo del logo. Se usó el mismo imagotipo de la castaña con una fuente diferente para la tipografía, pero parecida, así como un acomodo diferente según su uso (el tradicional óvalo del logo anterior y un logo horizontal nuevo).</h3>
            <h3 class="centered Roboto">Con esta nueva imagen se desarrolló una página Web, catálogo, flyers, etiquetas, cajas, entre otros.</h3>
          </div>
        </div>
      </div>
    </section>
    <section class="proyecto Roboto" style="background-color:#49342b; color: #fff; margin-top:-40px;">
        <div class="container">
          <div class="row" style="margin-top:40px; margin-bottom: 40px;">
            <div class="col-xs-12">
              <h1 class="centered" style="margin-bottom: 40px;">Etiquetas/Tarjetas de Presentación</h1>
            </div>
            <div class="col-xs-6">
              <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/etiqueta.png" class="img-responsive centered">
            </div>
            <div class="col-xs-6">
              <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/tarjetas.png" class="img-responsive centered">
            </div>
        </div>
    </section>
    ...
    <section class="proyecto Roboto">    
      <div class="container">
        ...
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs hidden-sm" style="height:160px"></div>
            <h1 class="centered" style="vertical-align:middle;">Web</h1>
            <h3 class="centered Roboto" style="vertical-align:middle;"><a href="http://lacastana.mx" target="_blank" class="Roboto">Entrar al sitio</a></h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="http://lacastana.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/web.png" class="img-responsive centered"></a>
          </div>
        </div>

        <div class="row" style="margin-bottom: 10px;">
          <div class="col-sm-6 col-xs-12">
            <h1 class="" style="vertical-align:middle;">Fotografía</h1>
          </div>
        </div>

        <div class="row-fluid" style="width:100%">
          <div id="owl-main" class="owl-carousel">
            <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/01.jpg" class="img-responsive"></div>
            <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/02.jpg" class="img-responsive"></div>
            <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/03.jpg" class="img-responsive"></div>
          </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 60px; margin-top: 40px;">
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs hidden-sm" style="height:160px"></div>
            <h1 class="centered">Caja Pasteles (conmemorativa del 30 aniversario)</h1>
          </div>
          <div class="col-sm-6 col-xs-12 ">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/castana/caja.jpg" class="img-responsive centered">
          </div>
        </div>
    ...
    <div class="modal fade" id="iFrameCastana" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://lacastana.mx/" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
