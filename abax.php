  ...
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/abax/01.jpg" class="img-responsvie hero" style="width:100%;">
      ...
      <div class="container">
        <div class="row" style="margin-top:60px;">
          <div class="col-sm-6 col-xs-12">
            <a href="http://abax.afr.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/abax/web_abax.png" class="img-responsive"></a>
          </div>
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Web</h1>
            <h3 class="centered Roboto"><a href="http://abax.afr.mx" target="_blank" data-toggle="modal" class="Roboto">Entrar al sitio</a></h3>
            </br>
            <h3 class="centered Roboto">Abax es un despacho de arquitectos.</h3> 
            <h3 class="centered Roboto">La página Web muestra principalmente fotografías de obras terminadas del despacho, divididas en 4 principales categorías, todas las secciones con el mismo diseño y siempre en orden aleatorio.</h3>
          </div>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs" style="height:160px"></div>
            <h1 class="centered " style="vertical-align:middle;">Web Móvil</h1>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/abax/web_movil.png" class="img-responsive centered" style="height:450px;">
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameAbax" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://abax.afr.mx" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
