...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/05.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:40px;">
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Logotipo</h1>
            </br>
            <h3 class="centered Roboto">Dharma es una banda de rock/pop mexicana de tres integrantes. Se desarrolló la imagen de la banda desde cero, logotipo, papelería, flyers, boletos, página Web y fotografías.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs" style="height:50px"></div>
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/logo.png" class="img-responsive centered" style="width:400px;">
          </div>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-xs-12">
            <h1 class="" style="float:right;">Folleto (Impreso y Diseño)</h1>
          </div>
          <div class="col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/folleto.png" class="img-responsive centered">
          </div>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-4 col-xs-12">
            <div class="hidden-xs" style="height:50px"></div>
            <h1 class=" centered">Tarjetas de Presentación</h1>
          </div>
          <div class="col-sm-8 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/tarjetas.png" class="img-responsive centered">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="proyecto Roboto" style="background-color:#322735; color:#fff;">
      <div class="container">
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <h1 class=" centered">Arte del Disco</h1>
          </div>
          <div class="col-sm-8 col-xs-12">
            <h3 class="centered Roboto">Su imagen se conforma por un logotipo tipográfico muy dinámico, hecho de manera que se pueda cambiar de color fácilmente según la imagen del disco en promoción, y la ilustración de un astronauta, diseño de <a href="http://craniodsgn.es/">CranioDsgn</a>.</h3>
          </div>
        </div>
        <div class="row" style="margin-bottom:40px;">
          <div class="col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/disco.png" class="img-responsive centered">
          </div>
        </div>
      </div>
    </section>

    <section class="proyecto Roboto" style="background-color:#ef5b48; color:#fff;">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h4 class="centered Roboto">“Este disco es una reflexión muy introspectiva de los altibajos y situaciones que envuelven al amor y su portada refleja exactamente eso. ¿Pero qué tiene que ver un astronauta con el corazón? Un astronauta, a pesar de tener un amor profundo por la luna y el espacio, debe alejarse de ellos para no morir, lo mismo en una relación, a veces hay que saber cuando retirarse a tiempo o correr el riesgo de perecer tal como lo haría una persona en el espacio sin oxígeno para respirar.”—Dharma.</h4>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="proyecto Roboto">
      <div class="container">
        <div class="row" style="margin-top:40px;">
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Fotografía y Video</h1>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div id="owl-main" class="owl-carousel">
              <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/fotos/01.jpg" class="img-responsive"></div>
              <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/fotos/02.jpg" class="img-responsive"></div>
              <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/fotos/03.jpg" class="img-responsive"></div>
              <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/fotos/04.jpg" class="img-responsive"></div>
              <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/fotos/05.jpg" class="img-responsive"></div>
              <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/fotos/06.jpg" class="img-responsive"></div>
            </div>
          </div>
          <div class="col-md-6">
            <iframe width="100%" height="360" src="//www.youtube.com/embed/dx0bxEUT5aE" frameborder="0" allowfullscreen></iframe>
          </div>
          <div class="col-md-6">
            <iframe width="100%" height="360" src="//www.youtube.com/embed/FCaZq9qqKfE" frameborder="0" allowfullscreen></iframe>
          </div>
        </div>
        ...
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs" style="height:160px"></div>
            <h1 class="centered">Web</h1>
            <h3 class="centered Roboto"><a href="http://dharma.la" target="_blank" data-toggle="modal" class="Roboto">Entrar al sitio</a></h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="http://dharma.la" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/dharma/web.png" class="img-responsive centered"></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameDharma" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            ...
            <div class="row">
              <iframe src="http://dharmamusic.mx" style=" background-color:#fff;" width="100%" height="700" id="iCuadro" marginheight="0" frameborder="0" onLoad="autoResize('iCuadro');"></iframe>
            </div>
      </div>
    </div>
