...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/neos/09.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:40px; margin-bottom:40px;">
          <div class="col-sm-6 col-xs-12">
            <a href="http://neos.com.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/neos/web.png" class="img-responsive"></a>
          </div>
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered">Web</h1>
            <h3 class="centered Roboto"><a href="http://neos.com.mx" target="_blank" class="Roboto">Entrar al sitio</a></h3>
            </br>
            <h3 class="centered Roboto">Este despacho de arquitectos tiene una imagen colorida e innovadora, por lo que la página Web debía ser igual. Se desarrolló una página acorde a su imagen, basada en fotografías de proyectos terminados y en curso, para mostrarle a potenciales clientes de lo que son capaces.</h3>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameNeos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
