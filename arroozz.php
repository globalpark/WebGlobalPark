...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/arroozz/02.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:60px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <h3 class="centered Roboto">Arroozz Disain es una empresa de diseño y cortes láser en tela, cartón, madera entre otros. La imagen está basada en frases de Mauricio Garcés.</h3>
            <h3 class="centered Roboto">El logotipo muestra dos caras iguales de perfil y en un sólo color, representando un corte láser como los que hacen.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/arroozz/logo.png" class="img-responsive centered" style="height:350px;">
          </div>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/arroozz/tarjetas.png" class="img-responsive centered">
          </div>
          <div class="col-sm-6 col-xs-12" >
            <h1 class="centered" style="vertical-align:middle;">Postal/Tarjeta de Presentación</h1>
            <h3 class="centered Roboto">Para las tarjetas de presentación, se hicieron volantes para anunciarse, teniendo más espacio para información sobre la empresa. La tarjeta queda en la parte de abajo con la opción de desprenderla para conservar los datos de la empresa.</h3>
          </div>
        ...
        <div class="row" style="margin-top:10px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <h1 class="centered Roboto" style="vertical-align:middle;">Web</h1>
            <h3 class="centered Roboto"><a href="http://arroozzdisain.com" target="_blank" class="Roboto">Entrar al sitio</a></h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="http://arroozzdisain.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/arroozz/web.png" class="img-responsive centered"></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameArroozz" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://arroozzdisain.com" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
            <div class="row">
