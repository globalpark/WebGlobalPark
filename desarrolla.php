...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/desarrolla/04.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:40px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <h3 class="centered Roboto">Desarrolla es una empresa dedicada a la capacitación de investigadores recién egresados de estudios de maestría o doctorado de universidades de México, Estados Unidos y Europa en los aspectos prácticos de la investigación de políticas públicas.</h3>
            <h3 class="centered Roboto">Usando el nombre como línea base se creó un logotipo con tonalidades azules comunicando fluidez y calidad a la vez que enfatiza sutilmente el mercado latinoamericano.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs" style="height:130px"></div>
            <a href="#" data-toggle="modal" data-target="#iFrameAbax"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/desarrolla/logo.png" class="img-responsive"></a>
          </div>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs" style="height:160px"></div>
            <h1 class="centered" style="vertical-align:middle;">Papelería</h1>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/desarrolla/papeleria.png" class="img-responsive centered">
          </div>
        </div>
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            <a href="http://desarrolla-la.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/desarrolla/web.png" class="img-responsive centered"></a>
          </div>
          <div class="col-sm-6 col-xs-12">
            <div class="hidden-xs" style="height:160px"></div>
            <h1 class="centered" style="vertical-align:middle;">Web</h1>
            <h3 class="centered Roboto"><a href="http://desarrolla-la.com" target="_blank" class="Roboto">Entrar al sitio</a></h3>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameDesarrolla" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="container" style="margin-top: 40px;">
            <div class="row">
              <iframe src="http://globalpark.mx" style=" width:100%; height:700px; background-color:#fff;"></iframe>
            </div>
      </div>
    </div>
