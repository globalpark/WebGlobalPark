...
<style type="text/css">
  h1{
    ...
    <section id="abaxMain" style="margin-top:65px;">
      <div>
        <div class="container-fluid mainProyecto" id="entraPortafolio">
          <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/sweet/12.jpg" class="img-responsvie" style="width:100%">
      ...
      <div class="container">
        <div class="row" style="margin-top:40px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <h3 class="centered Roboto">Sweet Delights es una empresa dedicada a la elaboración de chocolates y regalos para todo tipo de eventos. Regalos, dulces y un concepto vanguardista con chocolates gourmet de innovadores sabores y diferentes combinaciones.</h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/sweet/logo.png" class="img-responsive centered" style="width: 350px;">
          </div>
        </div>
        <div class="row" style="margin-top:40px;">
          <div class="col-sm-6 col-xs-12">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/sweet/tarjetas.png" class="img-responsive centered" style="width: 350px;">
          </div>
          <div class="col-sm-6 col-xs-12">
            <h1 class="centered " style="vertical-align:middle;">Etiquetas/Tarjeta de Presentación</h1>
            <h3 class="centered Roboto">Se creó la imagen desde el principio, usando un cupcake estilizado como imagotipo y una paleta de colores rosa y café, siendo colores típicos de dulcería.</h3>
            <h3 class="centered Roboto">Se desarrolló la imagen en aplicaciones como etiquetas de dos diferentes tamaños, papelería y una página Web.</h3>
          </div>
        ...
        <div class="row" style="margin-top:40px; margin-bottom: 40px;">
          <div class="col-sm-6 col-xs-12">
            ...
            <h3 class="centered Roboto"><a href="http://sweetdelights.mx" target="_blank" class="Roboto">Entrar al sitio</a></h3>
          </div>
          <div class="col-sm-6 col-xs-12">
            <a href="http://sweetdelights.mx" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/Portafolio/sweet/web.png" class="img-responsive centered"></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="modal fade" id="iFrameSweet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
